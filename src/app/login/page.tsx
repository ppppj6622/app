...
function LoginContent() {
  ...
  const [registerData, setRegisterData] = useState({
    username: "", password: "", nama_lengkap: "", kelas: "teknik", sub_kelas: "A",
  });
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      await db.init();
      if (registerData.kelas === "teknik" && !registerData.sub_kelas) throw new Error("Pilih sub kelas");
      ...
      setRegisterData({ username: "", password: "", nama_lengkap: "", kelas: "teknik", sub_kelas: "A" });
    } catch (err: any) {
      setError(err.message);
    } finally {
      setLoading(false);
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {registerData.kelas === "teknik" && (
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Sub Kelas</label>
